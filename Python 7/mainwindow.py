...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_3.setGeometry(QtCore.QRect(40, 160, 300, 10))
        ...
        self.pushButtonInsert.clicked.connect(self.insertmainwindow)
        self.pushButtonLoad.clicked.connect(self.loadmainwindow)

        self.retranslateUi(MainWindow)
        QtCore.QMetaObject.connectSlotsByName(MainWindow)

    def insertmainwindow(self):
        try:
            mydb = mc.connect(
                host ="localhost",
                user ="root",
            ...
            sql = "INSERT INTO mainwindow (ID,KATEGORI) VALUES (%s,%s)"
            val = (idkat,namekat)
    ...
    def loadmainwindow(self):
        try:
            ...
            mycursor.execute("SELECT * FROM mainwindow ORDER BY ID ASC")
            ...
            for row_number, row_data in enumerate(result):
                ...
                for column_number, data in enumerate(row_data):
                    ...
                    self.label_3.setText("Data Kategori Gagal di tampilkan")
